...
from dj_object_detection.object_detection.core import region_similarity_calculator
from dj_object_detection.object_detection.protos import region_similarity_calculator_pb2
