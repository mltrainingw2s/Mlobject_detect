        ...
        if not skip_labels:
          if not agnostic_mode:
            if classes[i] in six.viewkeys(category_index):
              ...
              print(class_name,"classeds")
              lab.append(class_name)

            else:
              class_name = 'N/A'
              if class_name not in count_objects:
                count_objects[class_name]=1
              else:
                count_objects[class_name]=count_objects[class_name]+1
...
# print(class_name)
# print(count_objects,"counting objects")
