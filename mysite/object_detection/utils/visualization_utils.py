...
def visualize_boxes_and_labels_on_image_array(
        ...
        if not skip_labels:
          if not agnostic_mode:
            if classes[i] in six.viewkeys(category_index):
              ...
              print("class",count_objects.append(class_name))
              # s = count_object(class_name)
              # print("s",s)
            else:
              class_name = ''
  ...
  return image,class_name,len(count_objects)
...
# def count_object(class_name):
  #  return len(count_objects)